...
ta_dic = pd.read_csv('data/SO289-64PE503_results_recalibrated.csv')

# Load CTD data
ctd = pd.read_csv('data/SO289_CTD_data.csv')
...
ta = pd.read_csv('data/SO289-TA_only_results.csv')
...
dic = pd.read_excel('data/raw_files/DIC_vials/230112 DIC LOUISE ER1R1_format_friendly.xlsx')
