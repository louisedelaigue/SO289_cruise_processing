...
# === DIC SAMPLES
DIC = pd.read_excel(
    "data/quaatro/DIC_vials/230112 DIC LOUISE DR1R1_format_friendly.xlsx"
)
...
# Add DIC back to df
df = pd.merge_asof(
    df, DIC, on="date_time", direction="nearest", tolerance=pd.Timedelta(minutes=5)
)
